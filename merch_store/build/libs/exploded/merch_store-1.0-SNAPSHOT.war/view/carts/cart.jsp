...
<section class="cart">
        ...
        <table class="table">
            ...
            <c:forEach var="cart" items="${carts}">
                <tr class="row">
                    ...
                    <td class="col-4 text-end"><h5>€${cart.getTotal()} EUR</h5></td>
                </tr>
            </c:forEach>
    ...
    <div class="container">
        ...
        <form action="/CustomerOrder?action=create" method="post">
            <div
                    class="row flex-row justify-content-center align-items-center justify-content-md-end">
                <p class="col-12 text-center text-md-end fs-2">
...
<div class="modal fade" tabindex="-1" id="modal-info">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form action="/CustomerOrder?action=update-info" method="post">
            <div class="modal-body">
                <div class="mb-3">
                    <label for="phoneNumber" class="col-form-label">Your phone number:</label>
                    <input type="tel" pattern="^[0][0-9]{9}$" title="e.g: 0123456789" class="form-control" id="phoneNumber" name="phoneNumber" required>
                </div>
                <div class="mb-3">
                    <label for="address" class="col-form-label">Your address:</label>
                    <input type="text" class="form-control" id="address" name="address" required
                           pattern="^\S.{3,}$" title="Must contain at least 4 characters long and no spaces at the beginning!">
                </div>
            </div>
            <div class="modal-footer">
