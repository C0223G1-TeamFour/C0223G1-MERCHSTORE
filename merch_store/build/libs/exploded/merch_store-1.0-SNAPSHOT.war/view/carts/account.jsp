<%@ page import="com.example.merch_store.model.Customer" %>
<%@ page import="java.util.List" %>
<%@ page import="com.example.merch_store.model.Order" %>
<%@ page import="com.example.merch_store.model.CustomerOrder" %>
...
<div class="modal fade" id="deleteOrder" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="/CustomerOrder?action=delete" method="post">
